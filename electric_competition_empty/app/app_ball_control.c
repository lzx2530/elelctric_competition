...
#define APP_BALL_STATIC_PHASE_1_TIME_S     (0.81F)
#define APP_BALL_STATIC_PHASE_2_TIME_S     (1.75F)
#define APP_BALL_STATIC_PHASE_3_TIME_S     (1.6F)
#define APP_BALL_STATIC_PHASE_4_TIME_S     (0.65F)
